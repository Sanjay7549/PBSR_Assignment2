...
cat("MLE : b0:", p_A$par[1], "b1:", p_A$par[2], "sigma:", exp(p_A$par[3]), " ")
...
cat("MLE : b0:", p_B$par[1], "b1:", p_B$par[2], "sigma:", exp(p_B$par[3]), " ")
...
cat("MLE : b0:", p_C$par[1], "b1:", p_C$par[2], "sigma:", exp(p_C$par[3]), " ")
...
cat("MLE : b0:", p_D$par[1], "b1:", p_D$par[2], "sigma:", exp(p_D$par[3]), " ")
